...
<body>
		...
		<div class="nav-wrapper">
			<div class="nav-wrapper">
                ...
                <ul id="nav-mobile" class="left hide-on-med-and-down">
                    ...
                    <li class="active"><a href="index.php">Pilotos</a></li>
	...
	<main>
		<div class="container">
			<div class="row">
				<div class="col m12">
					<h4 class="header">Pilotos</h4>
				</div>
			</div>

			<?php if(!empty($_GET['status']) && $_GET['status'] == 'salvo'): ?>
				<div id="page-warning" class="hide">
					<span>Piloto salvo com sucesso <i class="right material-icons green-text">check</i></span>
				</div>
			<?php endif; ?>

			<?php if(!empty($_GET['status']) && $_GET['status'] == 'excluido'): ?>
				<div id="page-warning" class="hide">
					<span>Piloto inativado com sucesso <i class="right material-icons green-text">check</i></span>
				</div>
			<?php endif; ?>     
			...
			<div class="modal-content">
				...
				<div class="row">
					<div class="input-field col s12">
						...
						<label for="nome-edicao">Piloto</label>
					</div>
				</div>
			</div>
			<div class="modal-footer">
...
<script type="text/javascript" src="pilotos.js"></script>
<script>
