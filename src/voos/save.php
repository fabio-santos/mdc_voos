...
$insert = <<<INSERT
INSERT INTO voos (data, comandante, copiloto, prevoo, posvoo, origem, destino, 
alternativa, rumo, distancia, nivel, pob, acionamento, decolagem, 
pouso, corte, kmh, combustivel_decolagem, combustivel_pouso, 
combustivel_consumido, ias, tas, gs, n1, egt, hp, torque, volts, 
amperes, fuel_press, oil_press, oil_temp, fueld_flow, oat, ativo) VALUES
...
pouso=:pouso, corte=:corte, kmh=:kmh, combustivel_decolagem=:combustivel_decolagem, combustivel_pouso=:combustivel_pouso, 
...
$safePost['kmh'] = converteDecimal($safePost['kmh']);
...
$stmt->bindParam(':kmh', $safePost['kmh']);
